/**
 * 3Flix — catalogue data.
 *
 * Every title here is a film widely regarded as being in the public domain
 * in the United States, which is why we can ship a streaming demo without
 * licensing anything. Posters are NOT bundled images — they are generated
 * at runtime from the `hue` value (see poster.js), so the app has zero
 * image assets and works completely offline.
 *
 * @typedef {Object} Film
 * @property {string}   id        Stable slug, used as the localStorage key.
...
export const FILMS = [
  {
    ...
    video:
      "https://archive.org/download/Nosferatu1922HD/Nosferatu%20%281922%29%20HD.mp4",
  },
  {
    id: "caligari",
    ...
    video:
      "https://archive.org/download/the-cabinet-of-dr.-caligari_202603/The%20Cabinet%20of%20Dr.%20Caligari.ia.mp4",
  },
  {
    ...
    video:
      "https://archive.org/download/night-of-the-living-dead-1968_202508/Night%20of%20the%20Living%20Dead%201968.mp4",
  },
  {
    id: "carnival-souls",
    ...
    video:
      "https://archive.org/download/carnival-of-souls_1962/Carnival%20Of%20Souls.mp4",
  },
  {
    id: "metropolis",
    title: "Metropolis",
    ...
    video:
      "https://archive.org/download/metropolis_202511/Metropolis%20.mp4",
  },
  {
    id: "trip-to-moon",
    ...
    video:
      "https://archive.org/download/a-trip-to-the-moon-1902_202507/A%20Trip%20To%20The%20Moon%20%281902%29.mp4",
  },
  {
    id: "last-man-earth",
    ...
    video:
      "https://archive.org/download/the-last-man-on-earth-1964_202312/The%20Last%20Man%20on%20Earth%20%281964%29.mp4",
  },
  {
    id: "plan-9",
    ...
    video:
      "https://archive.org/download/plan-9-from-outer-space/plan-9-from-outer-space.mp4",
  },
  {
    id: "the-general",
    title: "The General",
    ...
    video:
      "https://archive.org/download/TheGeneral/The_General_512kb.mp4",
  },
  {
    id: "sherlock-jr",
    title: "Sherlock Jr.",
    ...
    video:
      "https://archive.org/download/silent-sherlock-jr-/Sherlock%20Jr..mp4",
  },
  {
    id: "the-kid",
    title: "The Kid",
  ...
  },
  {
    ...
    video:
      "https://archive.org/download/HisGirlFriday1940/seqhisgirlfridayfull1d_512kb.mp4",
  },
  {
    id: "charade",
    title: "Charade",
    ...
    video:
      "https://archive.org/download/charade-1963-cary-grant-audrey-hepburn-comedy-mystery-romance-thriller-full-movie/Charade_READY.mp4",
  },
  {
    id: "doa",
    title: "D.O.A.",
    ...
    video:
      "https://archive.org/download/turner_video_143/143.mp4",
  },
  {
    id: "detour",
    title: "Detour",
    ...
    video:
      "https://archive.org/download/detour_ipod/Detour_512kb.mp4",
  },
  {
    id: "scarlet-street",
    ...
    video:
      "https://archive.org/download/scarlet-street-1945_202607/Scarlet%20Street%201945.ia.mp4",
  },
  {
    id: "the-stranger",
    title: "The Stranger",
  ...
  },
  {
    ...
    video:
      "https://archive.org/download/meet-john-doe-1941/Meet%20John%20Doe%20%281941%29.mp4",
  },
  {
    id: "potemkin",
    ...
    video:
      "https://archive.org/download/battleship-potemkin-1925_202607/Battleship%20Potemkin%20%281925%29.mp4",
  },
  {
    id: "nanook",
    ...
    video:
      "https://archive.org/download/NanookOfTheNorth/Nanook%20of%20the%20North.mp4",
  },
  {
    id: "haxan",
    title: "Häxan",
    ...
    genres: ["Documentary", "Horror", "Silent"],
    runtime: 91,
    rating: 7.6,
    hue: 286,
    ...
    video:
      "https://archive.org/download/Haxan1922/Haxan%20%281922%29.mp4",
  },
  {
    id: "phantom-opera",
    ...
    video:
      "https://archive.org/download/the-phantom-of-the-opera-1925-ben-model-score-sd/The%20Phantom%20of%20the%20Opera%20%281925%29%20-%20Ben%20Model%20Score%20%28SD%29.ia.mp4",
  },
  {
    id: "dementia-13",
    title: "Dementia 13",
    ...
    video:
      "https://archive.org/download/dementia.-13.1963/Dementia%2013%20%281963%29/mp4/Dementia.13.1963.mp4",
  },
  {
    id: "beat-the-devil",
    ...
    video:
      "https://archive.org/download/beat-the-devil_202407/BEAT%20THE%20DEVIL.mp4",
  },
];

/** Genre list for the dashboard filter bar, derived so it never drifts. */
export const GENRES = [...new Set(FILMS.flatMap((f) => f.genres))].sort();

/** Rows shown on the dashboard, in order. */
export const ROWS = [
  { id: "featured", title: "Because it defined the genre", filter: (f) => f.rating >= 7.8 },
  { id: "horror",   title: "Horror & the uncanny",         filter: (f) => f.genres.includes("Horror") },
  { id: "noir",     title: "Noir after midnight",          filter: (f) => f.genres.includes("Noir") },
  { id: "silent",   title: "Silent era",                   filter: (f) => f.genres.includes("Silent") },
  { id: "short",    title: "Under 80 minutes",             filter: (f) => f.runtime < 80 },
];

/** @param {number} mins @returns {string} e.g. "1h 34m" */
export const formatRuntime = (mins) =>
  mins < 60 ? `${mins}m` : `${Math.floor(mins / 60)}h ${mins % 60}m`;

/* Classic scripts share one namespace instead of ES module exports, because
   browsers block module imports over file:// — and this project has to open
   by double-clicking index.html, with no server. */
